...
import Assimp.AnimatedComponent;
import Assimp.Bone;
import Assimp.Matrix4f;
import Assimp.Util;
import engine.graphics.Mesh;

public class ModelLoader {
	public static final Mesh loadAnimatedFile(File file)
	{
		...
		vertices.flip();
		indices.flip();
		Mesh mesh=new Mesh(vertices.array(),indices.array(),bones,new Matrix4f[bones.length],inverseRootTransformation);
